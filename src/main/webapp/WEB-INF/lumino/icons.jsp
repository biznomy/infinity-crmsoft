...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="/crmsoft/companies"><svg class="glyph stroked chain"><use xlink:href="#stroked-chain"/></svg> companies</a></li>
			...
			<li class="active"><a href="icons"><svg class="glyph stroked star"><use xlink:href="#stroked-star"></use></svg> Icons</a></li>
			<li class="parent ">
				<!--  <a href="#">
